...
public class FileServerHandler extends SimpleChannelInboundHandler<String> {
	...
	protected void channelRead0(ChannelHandlerContext ctx, String msg)
		...
		//File file = new File("E:\\downloads\\google-Chrome-download\\wordCount.txt");
		if (file.exists()) {
		    if (!file.isFile()) {
			...
			while ((ch = fileInputStream.read(buff)) != -1){
				...
				String buffString = new String(buff,0,ch);
				stringBuffer.append(buffString);
			}
			ctx.write(stringBuffer.toString());
			ctx.flush();
